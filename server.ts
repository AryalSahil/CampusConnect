...
async function startServer() {
  ...
  app.post('/api/send-welcome-email', async (req, res) => {
    try {
      ...
      // Compile responsive modern HTML template matching Campus Connect's style branding
      const welcomeHtml = `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body>
          <div class="container">
            ...
            <p>
              Thank you for joining the Campus Connect waitlist. We are bringing leading Indian college students together in a brand new way, and you've officially claimed your exclusive spot.
            </p>
      ...
      if (process.env.SMTP_PASSWORD) {
        await transporter.sendMail({
          from: process.env.SMTP_FROM || '"Campus Connect" <welcome@campusconnect.edu>',
          to: email,
          subject: `🎒 You're on the list, ${fullName || 'Scholar'}! Welcome to Campus Connect`,
          text: `Welcome to Campus Connect! You are on the waitlist representing ${collegeName || 'your university'}. Your unique referral code is ${referralCode || 'CAMPUS-VIP'}.`,
          html: welcomeHtml,
        });
        ...
        console.log(`Subject: Welcome to Campus Connect, ${fullName || 'Scholar'}!`);
